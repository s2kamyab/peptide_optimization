...
from black_box_fcn_mo_MN_f import blackbox_fc
# ============================================================
# Config
# ============================================================
...
def main():
    ...
    final_bo_pareto_df.to_csv("bo_results/bo_final_pareto.csv", index=False)
    print(f"Final BO Pareto: {len(final_bo_pareto_df)} solutions -> bo_results/bo_final_pareto.csv")
    ...
    if len(final_bo_pareto_df) > 0:
        ...
        novel_dom_df.to_csv("bo_results/bo_pareto_dominates_train.csv", index=False)
        n_dominating = int(sum(dom_train_mask))
        print(f"BO solutions dominating training Pareto: {n_dominating} "
              f"-> bo_results/bo_pareto_dominates_train.csv")
    else:
        n_dominating = 0
