...
OPTIMIZED_CSV = "2026_06_24_Geoff_results/bo_results/bo_pareto_dominates_train_CU_after_flow_space_gp_wu_10.csv"
...
TRAIN_PARETO_CSV = "2026_06_24_Geoff_results/bo_results/train_pareto_cu_flow_space_gp.csv"

OUTPUT_DIR = "2026_06_24_Geoff_results/scrambling_control_CU_gp_after_flow_wu_10_edit"
...
TRANSFER_CHECKPOINT = (
     "transfer_gru_vae_flow_checkpoints_h32_z32_"
    "latent_conditioned_autoreg_rt001/"
    "best_total_loss_h32_z32_latent_conditioned_autoreg_rt.pt"
)
...
def decode_after_flow_latent(
    ...
    p1 = peptides[0]
    return p1#decode_logits_to_peptide(logits[0])
