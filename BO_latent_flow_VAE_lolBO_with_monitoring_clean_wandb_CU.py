...
def main():
    ...
    train_pareto_save_df.to_csv("bo_results/train_pareto_cu.csv", index=False)
    print(f"Training Pareto: {len(train_pareto_peptides)} solutions -> bo_results/train_pareto_cu.csv")
